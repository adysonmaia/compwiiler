/* Generated By:JavaCC: Do not edit this line. Grammar.java */
  ...
  final public void MainClass() throws ParseException {
    ...
    jj_consume_token(T_LCHAVE);
    jj_consume_token(T_PUBLIC);
    jj_consume_token(T_STATIC);
    jj_consume_token(T_VOID);
    jj_consume_token(T_MAIN);
    jj_consume_token(T_LPAR);
    jj_consume_token(T_STRING);
    jj_consume_token(T_LCOL);
    jj_consume_token(T_RCOL);
    jj_consume_token(T_ID);
    jj_consume_token(T_RPAR);
    jj_consume_token(T_LCHAVE);
    Statement();
    jj_consume_token(T_RCHAVE);
    jj_consume_token(T_RCHAVE);
  }
  ...
  final public void Statement() throws ParseException {
    if (jj_2_17(2)) {
      ...
      jj_consume_token(T_SYSTEM);
      jj_consume_token(T_DOT);
      jj_consume_token(T_OUT);
      jj_consume_token(T_DOT);
      jj_consume_token(T_PRINTLN);
      jj_consume_token(T_LPAR);
      Exp();
      jj_consume_token(T_RPAR);
      jj_consume_token(T_PVIRGULA);
  ...
  final public void ExpL() throws ParseException {
    if (jj_2_23(2)) {
      jj_consume_token(T_INTEGER_LITERAL);
    } else if (jj_2_24(2)) {
  ...
  private boolean jj_3_32() {
    if (jj_scan_token(T_OP_BIN)) return true;
    if (jj_3R_17()) return true;
    return false;
  }

  private boolean jj_3_33() {
    if (jj_scan_token(T_LCOL)) return true;
    if (jj_3R_17()) return true;
    return false;
  }

  private boolean jj_3_31() {
    if (jj_scan_token(T_LPAR)) return true;
    if (jj_3R_17()) return true;
    return false;
  }

  private boolean jj_3_30() {
    if (jj_scan_token(T_OP_UN)) return true;
    if (jj_3R_17()) return true;
    return false;
  }

  private boolean jj_3_29() {
    if (jj_scan_token(T_NEW)) return true;
    if (jj_scan_token(T_ID)) return true;
    return false;
  }
  ...
  private boolean jj_3_28() {
    if (jj_scan_token(T_NEW)) return true;
    if (jj_scan_token(T_INT)) return true;
    return false;
  }

  private boolean jj_3_27() {
    if (jj_scan_token(T_THIS)) return true;
    return false;
  }
  ...
  private boolean jj_3_23() {
    if (jj_scan_token(T_INTEGER_LITERAL)) return true;
    return false;
  }
  ...
  private boolean jj_3_20() {
    if (jj_scan_token(T_SYSTEM)) return true;
    if (jj_scan_token(T_DOT)) return true;
    return false;
  }
  ...
  private boolean jj_3_17() {
    if (jj_scan_token(T_LCHAVE)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_16()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(T_RCHAVE)) return true;
    return false;
  }
  ...
  private boolean jj_3R_15() {
    if (jj_scan_token(T_VIRGULA)) return true;
  ...
  private boolean jj_3R_13() {
    if (jj_scan_token(T_PUBLIC)) return true;
    if (jj_3R_16()) return true;
    return false;
  }
  ...
  private boolean jj_3_7() {
    if (jj_scan_token(T_CLASS)) return true;
    if (jj_scan_token(T_ID)) return true;
    return false;
  }
